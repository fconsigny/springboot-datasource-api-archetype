...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.configurations.documentation;
...
@OpenAPIDefinition(info = @Info(title = "Spring Boot Datasource Archetype", version = "1.0",
        description = " <h1> Greetings and User data handler </h1> " +
                ...
                "<p> documentation can be found on <a href=${symbol_escape}"https://github.com/fconsigny/springboot-datasource-api-archetype${symbol_escape}">Github</a></p>" +
                "<p> Happy Coding! </p> ",
